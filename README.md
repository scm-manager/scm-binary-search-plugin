...
Enriches the search index with binary file content

## Usage

Find out how this plugin works on the [plugin documentation page](https://scm-manager.org/plugins/scm-binary-search-plugin/docs/).
